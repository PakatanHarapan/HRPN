...
#define MONEY_SUPPLY                                    (UINT64_C(2600000000))
#define EMISSION_SPEED_FACTOR                           (20)
#define GENESIS_BLOCK_REWARD                            ((MONEY_SUPPLY / 100) * 10)
...
#define P2P_DEFAULT_PORT                                66680
#define RPC_DEFAULT_PORT                                66681
